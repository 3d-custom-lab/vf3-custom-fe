    ...
    <div className="min-h-screen bg-[#0A0F1F] flex items-center justify-center px-4">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center justify-center w-24 h-24 mb-8 rounded-full bg-red-500/20 border-2 border-red-500/50"
        >
        ...
        >
          ...
          <button
            onClick={() => navigate("/")}
            className="px-8 py-3 bg-cyan-600 text-white rounded-xl hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 flex items-center gap-2 group cursor-pointer"
          >
